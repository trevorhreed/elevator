...
public class MainFrame extends javax.swing.JFrame implements Elevator.ElevatorListener {
    private static final long serialVersionUID = 8324809297205374413L;
    ...
    public MainFrame() {
        ...
        try{
            ...
            final AudioInputStream dingAudioStream = AudioSystem.getAudioInputStream(dingSoundStream);
            ...
            final AudioInputStream doorsAudioStream = AudioSystem.getAudioInputStream(doorsSoundStream);
            ...
            JOptionPane.showMessageDialog(null, "Error loading resources: " + exc.getMessage(), "ERROR!",
    ...
    private void updateState() {
        ...
        final Map<Integer, List<Elevator.Direction>> floors = elevator.getRequests();
        ...
        btnFloor2Down
                .setBackground(floors.get(2).contains(Elevator.Direction.DOWN) ? Color.YELLOW : buttonDefaultColor);
        ...
        btnFloor3Down
                .setBackground(floors.get(3).contains(Elevator.Direction.DOWN) ? Color.YELLOW : buttonDefaultColor);

        btnFloor4.setBackground(floors.get(4).contains(Elevator.Direction.NONE) ? Color.YELLOW : buttonDefaultColor);
        btnFloor4Down
                .setBackground(floors.get(4).contains(Elevator.Direction.DOWN) ? Color.YELLOW : buttonDefaultColor);
    }

    @Override
    public void onElevatorUpdate(final Elevator.Command cmd) {
    ...
    private void initComponents() {
        ...
        final javax.swing.GroupLayout pnlInsideLayout = new javax.swing.GroupLayout(pnlInside);
        pnlInside.setLayout(pnlInsideLayout);
        pnlInsideLayout.setHorizontalGroup(
                pnlInsideLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(pnlInsideLayout
                        .createSequentialGroup().addContainerGap().addGroup(pnlInsideLayout
                                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(pnlInsideLayout
                                        .createSequentialGroup()
                                        .addComponent(btnClose, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(
                                                btnOpen, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(pnlInsideLayout.createSequentialGroup().addGap(19, 19, 19)
                                        .addGroup(pnlInsideLayout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                .addComponent(btnLobby, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGroup(pnlInsideLayout.createSequentialGroup()
                                                        .addComponent(btnFloor2, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                        .addComponent(btnFloor3, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                70, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btnFloor4, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap()));
        pnlInsideLayout.setVerticalGroup(pnlInsideLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlInsideLayout.createSequentialGroup().addContainerGap()
                        .addGroup(pnlInsideLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(btnFloor3, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btnFloor2, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btnFloor4, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addComponent(btnLobby, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(pnlInsideLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(btnClose, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(btnOpen, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(pnlInside, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(lbDoors, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createSequentialGroup().addComponent(lbDown).addGap(18, 18, 18)
                                .addComponent(lbFloor, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(18, 18, 18).addComponent(lbUp))
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(btnLobbyUp, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(82, 82, 82).addComponent(lbLobby))
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(btnFloor2Up, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(btnFloor2Down, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(lbFloor2))
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(btnFloor3Up, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(btnFloor3Down, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(lbFloor3))
                                        .addGroup(layout.createSequentialGroup().addGap(76, 76, 76)
                                                .addComponent(btnFloor4Down, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
                .createSequentialGroup().addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(lbDown)
                        .addComponent(lbFloor, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lbUp))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(lbDoors)
                .addGap(18, 18, 18)
                .addComponent(pnlInside, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnFloor4Down, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lbFloor4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnFloor3Up, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btnFloor3Down, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lbFloor3))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnFloor2Up, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btnFloor2Down, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lbFloor2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnLobbyUp, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void requestLiftActionHandler(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_requestLiftActionHandler
        final int floor = (int) ((javax.swing.JButton) evt.getSource()).getClientProperty("floor");
        final Elevator.Direction direction = (Elevator.Direction) ((javax.swing.JButton) evt.getSource())
                .getClientProperty("direction");
        elevator.requestALift(floor, direction);
        updateState();
    }// GEN-LAST:event_requestLiftActionHandler

    private void selectFloorActionHandler(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_selectFloorActionHandler
        final int floor = (int) ((javax.swing.JButton) evt.getSource()).getClientProperty("floor");
